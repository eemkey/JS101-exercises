//input: string (word), string of text (assigned to variable)
//output: integer representing the number of times the word appears in the text
//initialize count variable to 0.
//convert text string into array using space as the separator.
//loop through array 
//if element in array matches, then increase count by 1
